...
def draw_lattice_from_gml(G,
    ...
    if fig_size is None:
        ...
        graph_width = round(base_size + width_scale_factor * ((m + n) ** 0.51), 0)
    ...
    title_parts = []
    if 'generality' in G.graph:
        pl_type = f"g{G.graph['generality']}PL"
    else:
        pl_type = "PL"
...
Examples:
  ...
  python draw_lattice.py lattice.gml --no_auto_sizing --fig_size 12,10
    ...
    # Figure options
    parser.add_argument('--fig_size', type=str, default=None,
    ...
    # Z-score filtering
    parser.add_argument('--zscore_lb', type=float, default=None,
                       help='Z-score lower bound')
    parser.add_argument('--zscore_ub', type=float, default=None,
                       help='Z-score upper bound')
    parser.add_argument('--zscore_attr', type=str, default=None,
    ...
    parser.add_argument('--label_offset', type=str, default=None,
                       help='Label offset as x,y (default: 0.01,0.01 to match original)')
